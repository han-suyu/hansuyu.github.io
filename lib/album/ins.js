    ...
    function(module, exports, __webpack_require__) {
      ...
      var ctrler = function ctrler(data) {
        ...
        for (var i = 0, len = data.length; i < len; i++) {
          ...
          var key = y + "" + ((m + "").length == 1 ? "0" + m : m) + "" + ((d + "").length == 1 ? "0" + d : d);
          if (imgObj[key]) {
